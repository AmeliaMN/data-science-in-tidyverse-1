...
How many did each party win? *You try this one:*
...
Now let's examine just the flipped districts. We'll make our own new table just with them:
...
*Note: this data is for training purposes. A few actual results affecting flips aren't reflected here.*  
...
How many flipped districts were above vs. below the the national median income.  
*You try this one:*
...
Why don't *you try picking one this time:*
...
Could we do means for both mine and your choice both at the same time? We can, like this:
